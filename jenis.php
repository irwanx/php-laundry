        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h4 class="mt-4 text-primary">Jenis Layanan</h4>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Manajemen Jenis layanan Laundry</li>
                    </ol>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#contentData").on("click", "#EditButton", function() {
                var id_jenis = $(this).attr("value");
                $.ajax({
                    url: 'data-jenis/form-edit.php',
                    type: 'get',
                    data: {
                        id_jenis: id_jenis
                    },
            ...
            $("#contentData").on("submit", "#formAdd", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-jenis/service.php?action=save',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-jenis/service.php?action=edit',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("click", "#DeleteButton", function() {
                var id_jenis = $(this).attr("value");
                $.ajax({
                    url: 'data-jenis/service.php?action=delete',
                    type: 'post',
                    data: {
                        id_jenis: id_jenis
                    },

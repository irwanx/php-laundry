        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h4 class="mt-4 text-primary">layanan Laundry</h4>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Manajemen data layanan Laundry</li>
                    </ol>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#contentData").on("click", "#EditButton", function() {
                var id_layanan = $(this).attr("value");
                $.ajax({
                    url: 'data-layanan/form-edit.php',
                    type: 'get',
                    data: {
            ...
            $("#contentData").on("submit", "#formAdd", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-layanan/service.php?action=save',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-layanan/service.php?action=edit',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("click", "#DeleteButton", function() {
                var id_layanan = $(this).attr("value");
                $.ajax({
                    url: 'data-layanan/service.php?action=delete',
                    type: 'post',
                    data: {
                        id_layanan: id_layanan
                    },
        ...
        function loadData() {
            $.ajax({
                url: 'data-layanan/data-layanan.php',
                type: 'get',
                success: function(data) {
                    $('#contentData').html(data);
                }

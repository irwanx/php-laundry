        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h4 class="mt-4 text-primary">Data Pelanggan</h4>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Manajemen Data Pelanggan</li>
                    </ol>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#addButton").on("click", function() {
                $.ajax({
                    url: 'data-pelanggan/form-add.php',
                    type: 'get',
            ...
            $("#contentData").on("click", "#EditButton", function() {
                ...
                $.ajax({
                    url: 'data-pelanggan/form-edit.php',
                    type: 'get',
                    data: {
            ...
            $("#contentData").on("submit", "#formAdd", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-pelanggan/service.php?action=save',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("submit", "#formEdit", function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'data-pelanggan/service.php?action=edit',
                    type: 'post',
                    data: $(this).serialize(),
                    success: function(data) {
                        alert(data);
            ...
            $("#contentData").on("click", "#DeleteButton", function() {
                var id_pelanggan = $(this).attr("value");
                $.ajax({
                    url: 'data-pelanggan/service.php?action=delete',
                    type: 'post',
                    data: {
                        id_pelanggan: id_pelanggan
                    },
        ...
        function loadData() {
            $.ajax({
                url: 'data-pelanggan/data-pelanggan.php',
                type: 'get',
                success: function(data) {
                    $('#contentData').html(data);
                }
